      ...
      sections: [
        {
          ...
          summary:
            'Emprint 0.2.5 supports recent Mac computers (Apple or Intel chip) and 64-bit Windows. Pick the installer that matches your machine.',
          body:
      ...
      sections: [
        {
          ...
          title: '앱 설치하기',
          summary:
            'Emprint 0.2.5은 최근 맥(M1 등 Apple 칩 또는 Intel)과 64비트 Windows에서 실행됩니다. 사용 중인 기기에 맞는 설치 파일을 고르세요.',
          body:
